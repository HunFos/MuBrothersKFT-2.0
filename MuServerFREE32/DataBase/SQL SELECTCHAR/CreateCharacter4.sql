...
/****** Object:  StoredProcedure [dbo].[WZ_CreateCharacter4]    Script Date: 05/04/2021 22:19:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[WZ_CreateCharacter4] 
...
Begin
	...
	--====================================================================================
	If NOT EXISTS ( SELECT  Id  FROM  AccountCharacter4 WHERE Id = @AccountID )
		begin
			INSERT INTO dbo.AccountCharacter4(Id, GameID1, GameID2, GameID3, GameID4, GameID5, GameIDC) 
		...
		begin
			...
			SELECT @g1=GameID1, @g2=GameID2, @g3=GameID3, @g4=GameID4, @g5=GameID5 FROM dbo.AccountCharacter4 Where Id = @AccountID 			

			if( ( @g1 Is NULL) OR (Len(@g1) = 0))
				begin
					UPDATE AccountCharacter4 SET  GameID1 = @Name
					WHERE Id = @AccountID
				...
				begin
					UPDATE AccountCharacter4 SET  GameID2 = @Name
					WHERE Id = @AccountID
				...
				begin			
					UPDATE AccountCharacter4 SET  GameID3 = @Name
					WHERE Id = @AccountID
				...
				begin
					UPDATE AccountCharacter4 SET  GameID4 = @Name
					WHERE Id = @AccountID
				...
				begin
					UPDATE AccountCharacter4 SET  GameID5 = @Name
					WHERE Id = @AccountID
