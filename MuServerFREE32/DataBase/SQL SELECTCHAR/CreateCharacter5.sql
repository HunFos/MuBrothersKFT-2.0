...
/****** Object:  StoredProcedure [dbo].[WZ_CreateCharacter5]    Script Date: 05/04/2021 22:19:58 ******/
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[WZ_CreateCharacter5] 
...
Begin
	...
	--====================================================================================
	If NOT EXISTS ( SELECT  Id  FROM  AccountCharacter5 WHERE Id = @AccountID )
		begin
			INSERT INTO dbo.AccountCharacter5(Id, GameID1, GameID2, GameID3, GameID4, GameID5, GameIDC) 
		...
		begin
			...
			SELECT @g1=GameID1, @g2=GameID2, @g3=GameID3, @g4=GameID4, @g5=GameID5 FROM dbo.AccountCharacter5 Where Id = @AccountID 			

			if( ( @g1 Is NULL) OR (Len(@g1) = 0))
				begin
					UPDATE AccountCharacter5 SET  GameID1 = @Name
					WHERE Id = @AccountID
				...
				begin
					UPDATE AccountCharacter5 SET  GameID2 = @Name
					WHERE Id = @AccountID
				...
				begin			
					UPDATE AccountCharacter5 SET  GameID3 = @Name
					WHERE Id = @AccountID
				...
				begin
					UPDATE AccountCharacter5 SET  GameID4 = @Name
					WHERE Id = @AccountID
				...
				begin
					UPDATE AccountCharacter5 SET  GameID5 = @Name
					WHERE Id = @AccountID
